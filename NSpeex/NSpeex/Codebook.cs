...
namespace NSpeex
{
    ...
    {
        #region Excitation Codebook
        /// <summary>
        ///  Excitation Codebook
        /// </summary>
        public static readonly int[] exc_20_32_table = new int[640]
        {
        ...
        #endregion Excitation Codebook

        #region Excitation Codebook
        /// <summary>
        /// Excitation Codebook
        /// </summary>
        public static readonly int[] exc_10_16_table = new int[160]
        {
        ...
        ///  Excitation Codebook
        /// </summary>
        public static readonly int[] exc_10_32_table = new int[320]
        {
        ...
        /// Excitation Codebook
        /// </summary>
        public static readonly int[] exc_5_256_table = new int[1280]
        {
            -8, -37, 5, -43, 5,
            73, 61, 39, 12, -3,
            -61, -32, 2, 42, 30,
        ...
        /// Excitation Codebook
        /// </summary>
        public static readonly int[] exc_5_64_table = new int[320]
        {
            1, 5, -15, 49, -66,
            -48, -4, 50, -44, 7,
            37, 16, -18, 25, -26,
        ...
        /// Excitation Codebook
        /// </summary>
        public static readonly int[] exc_8_128_table = new int[1024]
        {
        ...
        #region Gain Codebook (narrowband)
        /// <summary>
        ///  Gain Codebook (narrowband)
        /// </summary>
        public static readonly int[] gain_cdbk_nb = new int[384]
        {
            //384
            -32, -32, -32,
            -28, -67, -5,
        ...
        #endregion Gain Codebook (narrowband)

        #region Gain Codebook (LBR)
        /// <summary>
        /// Gain Codebook (LBR)
        /// </summary>
        public static readonly int[] gain_cdbk_lbr = new int[96]
        {
            //96
            -32, -32, -32,
            -31, -58, -16,
        ...
        #endregion Gain Codebook (LBR)

        #region Excitation Codebook
        /// <summary>
        /// Excitation Codebook
        /// </summary>
        public static readonly int[] hexc_10_32_table = new int[320]
        {
        ...
        /// Excitation Codebook
        /// </summary>
        public static readonly int[] hexc_table = new int[1024]
        {
            //1024
        ...
        #region  LSP Codebook (high)
        /// <summary>
        ///  LSP Codebook (high)
        /// </summary>
        public static readonly int[] high_lsp_cdbk = new int[512]
        {
            //512
        ...
        #endregion  LSP Codebook (high)

        #region LSP Codebook (high)
        /// <summary>
        /// LSP Codebook (high)
        /// </summary>
        public static readonly int[] high_lsp_cdbk2 = new int[512]
        {
            //512
        ...
        #region Codebook (narrowband)
        /// <summary>
        /// Codebook (narrowband)
        /// </summary>
        public static readonly int[] cdbk_nb = new int[640]
        {
            //640
        ...
        #endregion Codebook (narrowband)

        #region Codebook (narrowband)
        /// <summary>
        ///  Codebook (narrowband)
        /// </summary>
        public static readonly int[] cdbk_nb_low1 = new int[320]
        {
            //320
            -34, -52, -15, 45, 2,
            23, 21, 52, 24, -33,
        ...
        /// Codebook (narrowband)
        /// </summary>
        public static readonly int[] cdbk_nb_low2 = new int[320]
        {
            //320
            -6, 53, -21, -24, 4,
            26, 17, -4, -37, 25,
        ...
        /// Codebook (narrowband)
        /// </summary>
        public static readonly int[] cdbk_nb_high1 = new int[320]
        {
            //320
            -26, -8, 29, 21, 4,
            19, -39, 33, -7, -36,
        ...
        /// Codebook (narrowband)
        /// </summary>
        public static readonly int[] cdbk_nb_high2 = new int[320]
        {
            //320
            11, 47, 16, -9, -46,
            -32, 26, -64, 34, -5,
        ...
        #region QMF (Quadratic Mirror Filter) table
        /// <summary>
        ...
        #endregion QMF (Quadratic Mirror Filter) table
