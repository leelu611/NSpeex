namespace NSpeex
{
   ...
   */
  public static readonly int[] gain_cdbk_nb = new int[384]{ //384
    -32,-32,-32,
    -28,-67,-5,
    -42,-6,-32,
    -57,-10,-54,
   ...
   * Gain Codebook (LBR)
   */
  public static readonly int[] gain_cdbk_lbr = new int[96]{ //96
    -32,-32,-32,
    -31,-58,-16,
    -41,-24,-43,
    -56,-22,-55,
   ...
   * Excitation Codebook
   */
  public static readonly int[] hexc_table = new int[1024]{ //1024
   ...
   * LSP Codebook (high)
   */
  public static readonly int[] high_lsp_cdbk = new int[512]{ //512
   ...
   * LSP Codebook (high)
   */
  public static readonly int[] high_lsp_cdbk2 = new int[512]{ //512
   ...
   * Codebook (narrowband)
   */
  public static readonly int[] cdbk_nb = new int[640]{ //640
   ...
   * Codebook (narrowband)
   */
  public static readonly int[] cdbk_nb_low1 = new int[320]{ //320
    -34,-52,-15,45,2,
    23,21,52,24,-33,
    -9,-1,9,-44,-41,
    -13,-17,44,22,-17,
   ...
   * Codebook (narrowband)
   */
  public static readonly  int[] cdbk_nb_low2 = new int[320]{ //320
    -6,53,-21,-24,4,
    26,17,-4,-37,25,
    17,-36,-13,31,3,
    -6,27,15,-10,31,
   ...
   * Codebook (narrowband)
   */
  public static readonly int[] cdbk_nb_high1 = new int[320]{ //320
    -26,-8,29,21,4,
    19,-39,33,-7,-36,
    56,54,48,40,29,
    -4,-24,-42,-66,-43,
   ...
   * Codebook (narrowband)
   */
  public static readonly int[] cdbk_nb_high2 = new int[320]{ //320
    11,47,16,-9,-46,
    -32,26,-64,34,-5,
    38,-7,47,20,2,
    -73,-99,-3,-45,20,
