...
namespace NSpeex
{
    public class Filters
    {
        ...
        /// <param name="mem"></param>
        /// <param name="ms"></param>
        public static void filter_mem2(float[] x, int xs, float[] num, float[] den, float[] y, 
            int ys, int N, int ord, float[] mem, int ms)
        {
            int i, j;
            float xi, yi;
            for (i = 0; i < N; i++)
        ...
        /// <param name="N"></param>
        /// <param name="ord"></param>
        public static void residue_percep_zero(float[] xx, int xxs, 
            float[] ak, float[] awk1, float[] awk2, float[] y, int N, int ord)
        {
            int i;
            float[] mem = new float[ord];
            //    for (i=0;i<ord;i++)
        ...
        /// <param name="M"></param>
        /// <param name="mem"></param>
        public static void qmf_decomp(float[] xx, float[] aa, float[] y1, float[] y2, int N, int M, float[] mem)
        {
            int i, j, k, M2;
            float[] a;
            float[] x;
